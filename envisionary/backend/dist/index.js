...
const reviewModel = mongoose.model('countries.Review', reviewSchema);
const resolvers = {
    Query: {
    ...
    Mutation: {
        addReview: (parent, args, context, info) => {
            ...
            console.log(review);
            mongoose.connection.db.collection("countries").findOneAndUpdate({ Country: args.country }, { $push: { Reviews: review }, });
            //{ $push: { Reviews: review }}),
        }
    }
};
